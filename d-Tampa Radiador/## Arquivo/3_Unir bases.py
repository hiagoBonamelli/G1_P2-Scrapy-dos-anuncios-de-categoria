...
path = ("C:/Users/Hiago Bonomelli/Documents/auxiliares/")
...
sql_create_anuncios_table = '''CREATE TABLE IF NOT EXISTS anuncios_sonda_lambda (
...
# adicionar dados
sql = ''' INSERT OR IGNORE INTO anuncios_sonda_lambda(url)
                    VALUES(?) '''
